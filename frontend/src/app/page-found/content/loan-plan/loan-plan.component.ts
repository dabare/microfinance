...
@Component({
  ...
  styleUrls: ['./loan-plan.component.scss']
})
export class LoanPlanComponent implements OnInit, AfterViewInit {
  ...
  constructor(private loanPlanService: LoanPlanService, private notifi: NotificationsService) {
  }
